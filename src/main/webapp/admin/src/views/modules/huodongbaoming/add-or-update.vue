        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='huodong'">
                    <el-form-item class="select" v-if="type!='info'"  label="社区活动" prop="huodongId">
                        <el-select v-model="ruleForm.huodongId" :disabled="ro.huodongId" filterable placeholder="请选择社区活动" @change="huodongChange">
                            <el-option
                ...
                <el-col :span="24" v-if="sessionTable !='huodong' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.huodongPhoto" label="活动图片" prop="huodongPhoto">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.huodongPhoto" label="活动图片" prop="huodongPhoto">
                ...
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="举办方" prop="huodongJubanfang">
                        <el-input v-model="huodongForm.huodongJubanfang"
                                  placeholder="举办方" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="举办方" prop="huodongJubanfang">
                            <el-input v-model="ruleForm.huodongJubanfang"
                                      placeholder="举办方" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="活动地点" prop="huodongdidian">
                        <el-input v-model="huodongForm.huodongdidian"
                ...
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="联系电话" prop="huodongPhone">
                        <el-input v-model="huodongForm.huodongPhone"
                                  placeholder="联系电话" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="联系电话" prop="huodongPhone">
                            <el-input v-model="ruleForm.huodongPhone"
                                      placeholder="联系电话" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="报名条件" prop="baomingtiaojian">
                        <el-input v-model="huodongForm.baomingtiaojian"
                                  placeholder="报名条件" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="报名条件" prop="baomingtiaojian">
                            <el-input v-model="ruleForm.baomingtiaojian"
                                      placeholder="报名条件" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="开始时间" prop="huodongKaishi">
                        <el-input v-model="huodongForm.huodongKaishi"
                                  placeholder="开始时间" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="开始时间" prop="huodongKaishi">
                            <el-input v-model="ruleForm.huodongKaishi"
                                      placeholder="开始时间" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="结束时间" prop="huodongJieshu">
                        <el-input v-model="huodongForm.huodongJieshu"
                                  placeholder="结束时间" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="结束时间" prop="huodongJieshu">
                            <el-input v-model="ruleForm.huodongJieshu"

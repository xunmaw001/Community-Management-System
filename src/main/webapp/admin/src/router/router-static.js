...
import center from '@/views/center'
    ...
    import gonggongfuwu from '@/views/modules/gonggongfuwu/list'
    ...
    import dictionaryGonggongfuwu from '@/views/modules/dictionaryGonggongfuwu/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryGonggongfuwu',
        name: '公共服务类型',
        component: dictionaryGonggongfuwu
    }
    ,{

    ...
    */
    ...
    public R save(@RequestBody HuodongEntity huodong, HttpServletRequest request){
        ...
        Wrapper<HuodongEntity> queryWrapper = new EntityWrapper<HuodongEntity>()
            ...
            .eq("huodong_jubanfang", huodong.getHuodongJubanfang())
            .eq("huodongdidian", huodong.getHuodongdidian())
            .eq("huodong_phone", huodong.getHuodongPhone())
            .eq("baomingtiaojian", huodong.getBaomingtiaojian())
            .eq("huodong_kaishi", huodong.getHuodongKaishi())
            .eq("huodong_jieshu", huodong.getHuodongJieshu())
            ;
...
//                            huodongEntity.setHuodongJubanfang(data.get(0));                    //举办方 要改的
//                            huodongEntity.setHuodongdidian(data.get(0));                    //活动地点 要改的
//                            huodongEntity.setHuodongPhone(data.get(0));                    //联系电话 要改的
//                            huodongEntity.setBaomingtiaojian(data.get(0));                    //报名条件 要改的
//                            huodongEntity.setHuodongKaishi(data.get(0));                    //开始时间 要改的
//                            huodongEntity.setHuodongJieshu(data.get(0));                    //结束时间 要改的
...
//                            huodongEntity.setCreateTime(date);//时间
                            ...
                            //把要查询是否重复的字段放入map中
                                ...
                                //联系电话
                                if(seachFields.containsKey("huodongPhone")){
                                    List<String> huodongPhone = seachFields.get("huodongPhone");
                                    huodongPhone.add(data.get(0));//要改的
                                }else{
                                    List<String> huodongPhone = new ArrayList<>();
                                    huodongPhone.add(data.get(0));//要改的
                                    seachFields.put("huodongPhone",huodongPhone);
                                }
                        }
                        ...
                        if(huodongEntities_huodongUuidNumber.size() >0 ){
                         ...
                         //联系电话
                        List<HuodongEntity> huodongEntities_huodongPhone = huodongService.selectList(new EntityWrapper<HuodongEntity>().in("huodong_phone", seachFields.get("huodongPhone")));
                        if(huodongEntities_huodongPhone.size() >0 ){
                            ArrayList<String> repeatFields = new ArrayList<>();
                            for(HuodongEntity s:huodongEntities_huodongPhone){
                                repeatFields.add(s.getHuodongPhone());
                            }
